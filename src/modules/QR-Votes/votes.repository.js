...
const createQrVote = async ({ qr_code_url, expires_at, id_event, created_by }) => {
    const result = await pool.query(
        `INSERT INTO qr_votes (qr_code_url, expires_at, active, id_event, created_by)
     VALUES ($1, $2, true, $3, $4)
     RETURNING *`,
        [qr_code_url, expires_at || null, id_event, created_by]
    );
...
const getProjectsByEvent = async (id_event) => {
    const result = await pool.query(
